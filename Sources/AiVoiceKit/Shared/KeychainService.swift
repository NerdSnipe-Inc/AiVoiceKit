// Sources/AiVoiceKit/Shared/KeychainService.swift
// Ported from FluidVoice/Sources/Fluid/Persistence/KeychainService.swift
// Changes: public access, service/account identifiers renamed to Alric.
import Foundation
import Security
...
/// Keys are stored as generic passwords scoped to the AiVoiceKit service.
public final class KeychainService {
    public nonisolated(unsafe) static let shared = KeychainService()

    private let service = "com.nerdsnipe.alric.voice.api-keys"
    private let account = "alricApiKeys"

    private init() {}

    // MARK: - Public API

    public func storeKey(_ key: String, for providerID: String) throws {
    ...
    public func fetchKey(for providerID: String) throws -> String? {
    ...
    public func containsKey(for providerID: String) -> Bool {
    ...
    public func fetchAllKeys() throws -> [String: String] {
        try self.loadStoredKeys()
    }

    public func storeAllKeys(_ values: [String: String]) throws {
        try self.saveStoredKeys(values)
    }

    public func legacyProviderEntries() throws -> [String: String] {
    ...
    public func removeLegacyEntries(providerIDs: [String] = []) throws {
        let targets: [String]
